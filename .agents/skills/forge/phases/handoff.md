...
3. **Include forge context** — the handoff/resume prompt should reference the plan's iteration history and key decisions, not just the final `plan.html` or compatibility `plan.md`. This helps the implementer understand WHY decisions were made.
